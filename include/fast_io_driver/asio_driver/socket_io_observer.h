...
template <typename T, ::std::integral ch_type> class basic_socket_io_observer
{
  public:
...
template <typename T, ::std::integral ch_type> inline constexpr void flush(basic_socket_io_observer<T, ch_type>) {}
} // namespace fast_io::asio_driver
