...
public:
	...
	explicit constexpr pyobject_file(native_handle_type pp) noexcept
		: pyobject_io_observer{pp}
	{}
	pyobject_file(pyobject_io_observer) noexcept = delete;
	pyobject_file(pyobject_file const &pob) noexcept
		: pyobject_io_observer{pob.p}
	{
	...
	constexpr pyobject_file(pyobject_file &&pob) noexcept
		: pyobject_io_observer{pob.p}
	{
		pob.p = nullptr;
	}
