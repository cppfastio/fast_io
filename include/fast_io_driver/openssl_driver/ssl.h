...
template <::std::integral ch_type> class basic_ssl_io_observer
{
  public:
...
template <::std::integral ch_type> inline ::std::size_t use_count(basic_ssl_io_observer<ch_type> siob)
{
    return static_cast<::std::size_t>(SSL_up_ref(siob.s));
}

template <::std::integral ch_type> inline void connect(basic_ssl_io_observer<ch_type> siob)
{
...
template <::std::integral ch_type> class basic_ssl_io_handle : public basic_ssl_io_observer<ch_type>
{
  public:
    using char_type = ch_type;
    using native_handle_type = SSL *;
...
template <::std::integral ch_type> class basic_ssl_file : public basic_ssl_io_handle<ch_type>
{
  public:
    using char_type = ch_type;
    using native_handle_type = SSL *;
...
template <::std::integral ch_type> using basic_ibuf_ssl_io_observer = basic_ibuf<basic_ssl_io_observer<ch_type>>;
template <::std::integral ch_type> using basic_ibuf_ssl_file = basic_ibuf<basic_ssl_file<ch_type>>;
