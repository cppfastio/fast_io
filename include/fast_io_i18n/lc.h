...
template <typename char_type> struct basic_lc_identification
{
...
template <typename char_type> struct basic_lc_monetary
{
...
template <typename char_type> struct basic_lc_numeric
{
...
template <typename char_type> struct basic_lc_time_era
{
...
template <typename char_type> struct basic_lc_time
{
...
template <typename char_type> struct basic_lc_messages
{
...
template <typename char_type> struct basic_lc_paper
{
...
template <typename char_type> struct basic_lc_telephone
{
...
template <typename char_type> struct basic_lc_name
{
...
template <typename char_type> struct basic_lc_address
{
...
template <typename char_type> struct basic_lc_measurement
{
...
template <typename char_type> struct basic_lc_keyboard
{
...
template <typename char_type> struct basic_lc_all
{
