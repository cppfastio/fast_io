...
struct lc_imbuer
{
	...
	using lc_type = basic_lc<char_type>;
...
inline constexpr auto imbue(basic_lc<typename std::remove_cvref_t<stm>::char_type> const *locale, stm &&out) noexcept
{
	return lc_imbuer{locale, ::fast_io::operations::output_stream_ref(out)};
}
