...
inline void* win32_family_load_l10n_impl(path_type const& p,lc_locale& loc)
{
	return ::fast_io::win32_family_api_common<family>(p,[&loc](auto const* cstr_ptr,std::size_t n)
	{
		...
		native_char_type_may_alias_const_ptr cstr{reinterpret_cast<native_char_type_may_alias_const_ptr>(cstr_ptr)};
...
public:
	...
	{
		this->dll_handle=::fast_io::details::win32_family_load_l10n_impl<family>(loc,mode);
	}
