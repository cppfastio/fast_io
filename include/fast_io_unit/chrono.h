...
template <::std::integral char_type, typename Rep, typename Period>
	requires(reserve_printable<char_type, Rep> &&
			 (::std::same_as<Period, ::std::nano> || ::std::same_as<Period, ::std::micro> ||
			  ::std::same_as<Period, ::std::milli> || ::std::same_as<Period, ::std::ratio<1>> ||
...
inline constexpr Iter print_reserve_define(io_reserve_type_t<char_type, ::std::chrono::year>, Iter it,
										   ::std::chrono::year year) noexcept
{
...
template <::std::integral char_type, ::std::random_access_iterator Iter>
inline constexpr Iter print_reserve_define(io_reserve_type_t<char_type, ::std::chrono::month>, Iter it,
...
template <::std::integral char_type, ::std::random_access_iterator Iter>
inline constexpr Iter print_reserve_define(io_reserve_type_t<char_type, ::std::chrono::day>, Iter it,
										   ::std::chrono::day m) noexcept
{
	return details::chrono_two_digits_impl(it, static_cast<unsigned>(m));
}
...
template <::std::integral char_type, ::std::random_access_iterator Iter>
inline constexpr Iter print_reserve_define(io_reserve_type_t<char_type, ::std::chrono::weekday>, Iter it,
...
{
	if constexpr (requires() { ymd.year(); })
	{
...
{
	return print_reserve_size(io_reserve_type<char_type, ::std::chrono::month>) +
		   print_reserve_size(io_reserve_type<char_type, ::std::chrono::day>) + 3;
}

template <::std::integral char_type, ::std::random_access_iterator Iter>
inline constexpr Iter print_reserve_define(io_reserve_type_t<char_type, ::std::chrono::month_day>, Iter it,
										   ::std::chrono::month_day md) noexcept
{
...
{
	return print_reserve_size(io_reserve_type<char_type, ::std::chrono::year>) +
		   print_reserve_size(io_reserve_type<char_type, ::std::chrono::month>) + 1;
}

template <::std::integral char_type, ::std::random_access_iterator Iter>
inline constexpr Iter print_reserve_define(io_reserve_type_t<char_type, ::std::chrono::year_month>, Iter it,
...
{
	return print_reserve_size(io_reserve_type<char_type, ::std::chrono::year_month>) +
		   print_reserve_size(io_reserve_type<char_type, ::std::chrono::day>) + 1;
}

template <::std::integral char_type, ::std::random_access_iterator Iter>
inline constexpr Iter print_reserve_define(io_reserve_type_t<char_type, ::std::chrono::year_month_day>, Iter it,
...
inline constexpr Iter print_hh_mm_ss_reserve_define_impl(
	Iter it, ::std::chrono::hh_mm_ss<::std::chrono::duration<int_type, ::std::ratio<1, den>>> hms) noexcept
{
	...
	{
		return subseconds_part_print_sz_impl<static_cast<::std::uintmax_t>(den), char_type>(
			it, static_cast<::std::make_unsigned_t<::std::common_type_t<::std::intmax_t, ::std::chrono::seconds::rep>>>(
					hms.subseconds().count()));
	}
}
} // namespace details

template <::std::integral char_type, ::std::random_access_iterator Iter, details::my_integral int_type,
		  ::std::intmax_t den>
	requires(details::denom_is_natural_pow10(den))
...
print_system_clock_reserve_impl(Iter it, ::std::chrono::time_point<::std::chrono::system_clock, Duration> tp) noexcept
{
...
inline constexpr ::std::size_t print_reserve_size(
	io_reserve_type_t<char_type, ::std::chrono::time_point<::std::chrono::system_clock, Duration>>) noexcept
{
	/*
	ISO8601 Time stamp
	2020-11-08T07:23:27Z
	*/
	return print_reserve_size(io_reserve_type<char_type, int>) + sizeof(u8"-11-08T07:23:27Z") + 1 +
		   print_reserve_size(io_reserve_type<char_type, ::std::intmax_t>);
}
template <::std::integral char_type, ::std::random_access_iterator Iter, typename Duration>
	requires(::std::same_as<Duration, ::std::chrono::system_clock::duration>)
inline constexpr Iter
print_reserve_define(io_reserve_type_t<char_type, ::std::chrono::time_point<::std::chrono::system_clock, Duration>>,
