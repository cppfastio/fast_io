...
template <typename flt> struct iec559_traits;

#if defined(__SIZEOF_FLOAT16__) || defined(__FLOAT16__)
template <> struct iec559_traits<__float16>
{
...
template <> struct iec559_traits<float>
{
...
template <> struct iec559_traits<double>
{
...
template <> struct iec559_traits<__float128>
{
...
template <> struct iec559_traits<_Float16>
{
    using mantissa_type = ::std::uint_least16_t;
    inline static constexpr ::std::size_t mbits{10};
    inline static constexpr ::std::size_t ebits{5};
...
template <> struct iec559_traits<_Float32>
{
    using mantissa_type = ::std::uint_least32_t;
    inline static constexpr ::std::size_t mbits{23};
    inline static constexpr ::std::size_t ebits{8};
...
template <> struct iec559_traits<_Float64>
{
    using mantissa_type = ::std::uint_least64_t;
    inline static constexpr ::std::size_t mbits{52};
    inline static constexpr ::std::size_t ebits{11};
...
template <> struct iec559_traits<_Float128>
{
    using mantissa_type = __uint128_t;
    inline static constexpr ::std::size_t mbits{112};
    inline static constexpr ::std::size_t ebits{15};
...
*/
template <> struct iec559_traits<decltype(0.0bf16)>
{
    using mantissa_type = ::std::uint_least16_t;
...
template <::std::floating_point flt> struct iec559_rep
{
...
template <bool uppercase, ::std::integral char_type> inline constexpr char_type *prsv_fp_hex_0(char_type *iter) noexcept
{
    if constexpr (uppercase)
    {
        if constexpr (::std::same_as<char_type, char>)
...
template <bool uppercase, ::std::integral char_type> inline constexpr char_type *prsv_fp_dece0(char_type *iter) noexcept
{
    if constexpr (uppercase)
    {
        if constexpr (::std::same_as<char_type, char>)
...
template <typename flt> struct punning_result
{
