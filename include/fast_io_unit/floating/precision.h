...
template <::std::unsigned_integral T>
	requires(sizeof(T) == sizeof(::std::uint_least16_t) || sizeof(T) == sizeof(::std::uint_least32_t) ||
			 sizeof(T) == sizeof(::std::uint_least64_t))
inline constexpr T factor_mulassign{sizeof(::std::uint_least16_t) == sizeof(T)
										? 100u
										: (sizeof(::std::uint_least32_t) == sizeof(T) ? 10000u : 1000000000ULL)};

template <::std::unsigned_integral T>
	requires(sizeof(T) == sizeof(::std::uint_least16_t) || sizeof(T) == sizeof(::std::uint_least32_t) ||
			 sizeof(T) == sizeof(::std::uint_least64_t))
inline constexpr ::std::uint_least32_t factor_mulassigndigits{
	sizeof(::std::uint_least16_t) == sizeof(T) ? 2 : (sizeof(::std::uint_least32_t) == sizeof(T) ? 4 : 9)};

template <::std::unsigned_integral T>
inline constexpr ::std::size_t mulassign(T *data, T *__restrict temp, ::std::size_t na, T const *bdatai,
...
template <::std::unsigned_integral T>
inline constexpr ::std::size_t sqrassign(T *__restrict data, T *__restrict temp, ::std::size_t n) noexcept
{
...
template <::std::unsigned_integral T>
inline constexpr ::std::size_t pow_full(T *__restrict res, T *__restrict temp, T *__restrict base,
...
{
	return chars_len_precision_tree<0, factor_mulassigndigits<::std::size_t> - 1>(
			   static_cast<::std::uint_least32_t>(u)) +
		   1;
}
...
inline constexpr ::std::size_t precision_m2_e2_common(::std::size_t *res, typename iec559_traits<flt>::mantissa_type m2,
													  ::std::int_least32_t e2) noexcept
{
	using trait = iec559_traits<flt>;
	using mantissa_type = typename iec559_traits<flt>::mantissa_type;

	constexpr ::std::uint_least32_t m10digits{iec559_traits<flt>::m10digits};
	constexpr ::std::uint_least32_t digitsperunsigned{m10digits / factor_mulassigndigits<::std::size_t>};
	constexpr ::std::uint_least32_t digitsmod{m10digits % factor_mulassigndigits<::std::size_t>};
	constexpr ::std::uint_least32_t requiredbuffersize{digitsperunsigned + (digitsmod != 0)};
	::std::size_t tempbuffer[requiredbuffersizevamx<flt>], base[requiredbuffersizevamx<flt>];
	::std::size_t resn1{1};
...
#endif
template <::std::integral char_type, bool showpos, bool uppercase, bool uppercase_e, bool comma,
		  ::fast_io::manipulators::floating_format mt, typename flt>
inline constexpr char_type *precision_m2_e2(typename iec559_traits<flt>::mantissa_type m2, ::std::int_least32_t e2,
...
inline constexpr char_type *precision_flt(char_type *iter, flttype f, ::std::size_t precision) noexcept
{
	...
	return precision_m2_e2<char_type, showpos, uppercase, uppercase_e, comma, mt, flttype>(mantissa, exponent, iter,
																						   precision);
}
