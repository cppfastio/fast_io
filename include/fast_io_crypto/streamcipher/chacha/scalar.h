...
inline constexpr void chachaqr(::std::uint_least32_t &__restrict a, ::std::uint_least32_t &__restrict b,
							   ::std::uint_least32_t &__restrict c, ::std::uint_least32_t &__restrict d) noexcept
{
	a += b;
	d ^= a;
	d = ::std::rotl(d, 16);
...
inline
	...
	constexpr
#endif
	void chacha_main_routine(::std::byte *__restrict outdata, ::std::uint_least32_t const *__restrict indata) noexcept
{
	...
	constexpr ::std::uint_least8_t rounds{20};
	constexpr ::std::uint_least8_t roundsdiv2{rounds / 2};
