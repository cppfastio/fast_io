...
#endif
inline void
chacha_simd16_qr4_round_impl(::fast_io::intrinsics::simd_vector<::std::uint_least32_t, 4> &__restrict a,
							 ...
							 ::fast_io::intrinsics::simd_vector<::std::uint_least32_t, 4> &__restrict d) noexcept
{
								   ...
								   ::std::uint_least32_t const *__restrict indata) noexcept
{
	...
	constexpr ::std::uint_least8_t roundsdiv4{rounds / 4};
