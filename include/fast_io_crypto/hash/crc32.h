...
#if __has_builtin(__builtin_arm_crc32b) ||    \
	__has_builtin(__builtin_riscv_crc32_b) || \
	__has_builtin(__builtin_loongarch_crc32_b)
	true
#endif
};
...
#elif __has_builtin(__builtin_riscv_crc32_b)
		crc = __builtin_riscv_crc32_b(crc, static_cast<::std::uint_least8_t>(*i));
#elif __has_builtin(__builtin_loongarch_crc32_b)
		crc = __builtin_loongarch_crc32_b(crc, static_cast<::std::uint_least8_t>(*i));
#else
...
inline constexpr bool support_hardware_crc32c{
	...
	__has_builtin(__builtin_arm_crc32cb) ||        \
	__has_builtin(__builtin_riscv_crc32c_b) ||     \
	__has_builtin(__builtin_loongarch_crc32c_b) || \
...
#elif __has_builtin(__builtin_arm_crc32cb)
		crc = __builtin_arm_crc32cb(crc, static_cast<::std::uint_least8_t>(*i));
#elif __has_builtin(__builtin_riscv_crc32c_b)
		crc = __builtin_riscv_crc32c_b(crc, static_cast<::std::uint_least8_t>(*i));
#elif __has_builtin(__builtin_loongarch_crc32c_b)
		crc = __builtin_loongarch_crc32c_b(crc, static_cast<::std::uint_least8_t>(*i));
