...
[[msvc::forceinline]]
#endif
inline constexpr void sha256_scalar_round(::std::uint_least32_t T1k, ::std::uint_least32_t a, ::std::uint_least32_t b,
										  ::std::uint_least32_t &__restrict d, ::std::uint_least32_t e,
										  ::std::uint_least32_t f, ::std::uint_least32_t g,
										  ::std::uint_least32_t &__restrict h,
										  ::std::uint_least32_t &__restrict bpc) noexcept
{
...
#endif
	void
	sha256_do_constexpr_function(::std::uint_least32_t *__restrict state, ::std::byte const *__restrict data,
								 ::std::byte const *__restrict blocks_last) noexcept
{
	::std::uint_least32_t a{state[0]}, b{state[1]}, c{state[2]}, d{state[3]}, e{state[4]}, f{state[5]}, g{state[6]},
...
#if defined(__SSE2__) && (!defined(__SHA__) || !defined(__SSSE3__)) && __has_cpp_attribute(__gnu__::__target__) && \
...
struct sha224_initializer
{
	...
	static inline constexpr ::fast_io::details::sha256::sha256 initialize_value{
...
namespace fast_io
{
using sha224_context =
	::fast_io::details::basic_md5_sha_context_impl<::fast_io::details::sha256::sha256,
												   ::fast_io::details::sha256::sha224_initializer, 64>;
using sha256_context =
	::fast_io::details::basic_md5_sha_context_impl<::fast_io::details::sha256::sha256,
												   ::fast_io::details::sha256::sha256_initializer, 64>;
} // namespace fast_io
