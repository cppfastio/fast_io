...
#endif
inline void
sha512_simd16_byte_swap_message_2rounds(::fast_io::intrinsics::simd_vector<::std::uint_least64_t, 2> &__restrict s1,
										::std::byte const *__restrict blocks_start, ::std::uint_least64_t *__restrict w,
										::std::uint_least64_t *__restrict wt, ::std::uint_fast16_t round) noexcept
{
...
#endif
inline void
sha512_simd16_compute_message_2rounds(::fast_io::intrinsics::simd_vector<::std::uint_least64_t, 2> &__restrict s1,
									  ::std::uint_least64_t *__restrict w, ::std::uint_least64_t *__restrict wt,
									  ::std::uint_fast8_t round) noexcept
{
	using namespace ::fast_io::intrinsics;
	simd_vector<::std::uint_least64_t, 2> s0;
	s0.load(w + (round - 15));
