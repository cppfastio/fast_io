...
template <operation op> inline constexpr auto unit(auto const x, auto const y, auto const z) noexcept
{
...
template <operation op> inline constexpr void uu(auto &a, auto b, auto c, auto d, auto x, int s, auto ac) noexcept
{
    x += ac;
    x += a;
    x += unit<op>(b, c, d);
...
template <operation op> inline constexpr void uutmp(auto &tmp, auto &a, auto b, auto d, auto x, int s, auto ac) noexcept
{
    x += ac;
    x += a;
