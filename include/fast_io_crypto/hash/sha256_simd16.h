...
#endif
inline void
sha256_simd16_byte_swap_message_4rounds(::fast_io::intrinsics::simd_vector<::std::uint_least32_t, 4> &__restrict s1,
										::std::byte const *__restrict blocks_start, ::std::uint_least32_t *__restrict w,
										::std::uint_least32_t *__restrict wt, ::std::size_t round) noexcept
{
...
#endif
inline void
sha256_simd16_compute_message_4rounds(::fast_io::intrinsics::simd_vector<::std::uint_least32_t, 4> &__restrict s1,
									  ::std::uint_least32_t *__restrict w, ::std::uint_least32_t *__restrict wt,
