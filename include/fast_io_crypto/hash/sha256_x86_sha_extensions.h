								   ...
								   ::std::byte const *__restrict blocks_last) noexcept
{
	...
	simd_vector<int, 4> state0st{static_cast<int>(state[5]), static_cast<int>(state[4]), static_cast<int>(state[1]),
								 static_cast<int>(state[0])};
	simd_vector<int, 4> state1st{static_cast<int>(state[7]), static_cast<int>(state[6]), static_cast<int>(state[3]),
