...
extern ::std::uint_least32_t
	...
	__stdcall
#endif
	BCryptGetProperty(void *, char16_t const *, void *, ::std::uint_least32_t, ::std::uint_least32_t *,
...
extern ::std::uint_least32_t
	...
	__stdcall
#endif
	BCryptCreateHash(void *, void **, void *, ::std::uint_least32_t, void *, ::std::uint_least32_t,
					 ::std::uint_least32_t) noexcept
#if defined(__clang__) || defined(__GNUC__)
#if SIZE_MAX <= UINT_LEAST32_MAX && (defined(__x86__) || defined(_M_IX86) || defined(__i386__))
#if !defined(__clang__)
