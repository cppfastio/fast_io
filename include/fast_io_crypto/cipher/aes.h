...
struct aes
{
	...
	inline explicit aes(::std::span<::std::byte const, key_size> key_span) noexcept
	{
		...
		else if constexpr (keysize == 24)
		{
			...
			key_schedule[1] = reinterpret_cast<__m128i>(
				_mm_shuffle_pd(reinterpret_cast<__m128d>(key_schedule[1]), reinterpret_cast<__m128d>(temp[0]), 0));
			key_schedule[2] = reinterpret_cast<__m128i>(
				_mm_shuffle_pd(reinterpret_cast<__m128d>(temp[0]), reinterpret_cast<__m128d>(temp[1]), 1));
			...
			key_schedule[4] = reinterpret_cast<__m128i>(
				_mm_shuffle_pd(reinterpret_cast<__m128d>(key_schedule[4]), reinterpret_cast<__m128d>(temp[0]), 0));
			key_schedule[5] = reinterpret_cast<__m128i>(
				_mm_shuffle_pd(reinterpret_cast<__m128d>(temp[0]), reinterpret_cast<__m128d>(temp[1]), 1));
			...
			key_schedule[7] = reinterpret_cast<__m128i>(
				_mm_shuffle_pd(reinterpret_cast<__m128d>(key_schedule[7]), reinterpret_cast<__m128d>(temp[0]), 0));
			key_schedule[8] = reinterpret_cast<__m128i>(
				_mm_shuffle_pd(reinterpret_cast<__m128d>(temp[0]), reinterpret_cast<__m128d>(temp[1]), 1));
			...
			key_schedule[10] = reinterpret_cast<__m128i>(
				_mm_shuffle_pd(reinterpret_cast<__m128d>(key_schedule[10]), reinterpret_cast<__m128d>(temp[0]), 0));
			key_schedule[11] = reinterpret_cast<__m128i>(
				_mm_shuffle_pd(reinterpret_cast<__m128d>(temp[0]), reinterpret_cast<__m128d>(temp[1]), 1));
