...
template <::std::integral char_type, typename traits_type>
inline ::fast_io::io_scatter_status_t filebuf_scatter_pread_bytes_impl(::std::basic_filebuf<char_type, traits_type> *fb,
...
scatter_pread_some_bytes_underflow_define(::fast_io::basic_filebuf_io_observer<char_type, traits_type> fiob,
...
template <::std::integral char_type, typename traits_type>
	requires ::fast_io::operations::decay::defines::has_scatter_pwrite_some_bytes_overflow_define<
		::fast_io::basic_c_io_observer_unlocked<char_type>>
inline ::fast_io::io_scatter_status_t
scatter_pwrite_some_bytes_overflow_define(::fast_io::basic_filebuf_io_observer<char_type, traits_type> fiob,
										  ::fast_io::io_scatter_t const *pscatters, ::std::size_t n,
										  ::fast_io::intfpos_t fpos)
{
