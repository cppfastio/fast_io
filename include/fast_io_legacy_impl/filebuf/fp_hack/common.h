...
struct filebuf_guard
{
	...
	inline constexpr filebuf_guard() noexcept = default;
	inline explicit constexpr filebuf_guard(filebuf_type *fb) noexcept
		: new_filebuf{fb}
	{}
	inline filebuf_guard(filebuf_guard const &) = delete;
	inline filebuf_guard &operator=(filebuf_guard const &) = delete;
