...
template <typename T> inline FILE *stdinbuf_stdoutbuf_fp_hack(T *stdbuf) noexcept
{
    FILE *fp{};
...
template <class _CharT, class _Traits> class libcxx_basic_filebuf_model : public ::std::basic_streambuf<_CharT, _Traits>
{
  public:
