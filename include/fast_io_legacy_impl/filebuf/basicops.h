...
template <typename T>
inline typename T::char_type *read_some_overflow_define(::fast_io::basic_general_streambuf_io_observer<T> fb,
...
template <typename T>
inline constexpr ::fast_io::basic_general_streambuf_io_observer<T>
io_stream_ref_define(::fast_io::basic_general_streambuf_io_observer<T> other) noexcept
{
    return other;
}
