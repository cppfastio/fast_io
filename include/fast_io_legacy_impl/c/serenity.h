...
{
	return ::fast_io::details::serenity_ibuffer_begin(
		reinterpret_cast<::fast_io::details::serenity_file_model *>(bciob.fp));
}
...
{
	return ::fast_io::details::serenity_ibuffer_curr(
		reinterpret_cast<::fast_io::details::serenity_file_model *>(bciob.fp));
}
...
{
	return ::fast_io::details::serenity_ibuffer_end(
		reinterpret_cast<::fast_io::details::serenity_file_model *>(bciob.fp));
}
...
inline void ibuffer_set_curr(basic_c_io_observer_unlocked<char_type> bciob, char_type *
							 ...
							 ptr) noexcept
{
	::fast_io::details::serenity_ibuffer_set_curr(reinterpret_cast<::fast_io::details::serenity_file_model *>(bciob.fp),
...
{
	return ::fast_io::details::serenity_ibuffer_underflow(
		reinterpret_cast<::fast_io::details::serenity_file_model *>(bciob.fp));
}
...
{
	return ::fast_io::details::serenity_obuffer_begin(
		reinterpret_cast<::fast_io::details::serenity_file_model *>(bciob.fp));
}
...
{
	return ::fast_io::details::serenity_obuffer_curr(
		reinterpret_cast<::fast_io::details::serenity_file_model *>(bciob.fp));
}
...
{
	return ::fast_io::details::serenity_obuffer_end(
		reinterpret_cast<::fast_io::details::serenity_file_model *>(bciob.fp));
}
...
inline void obuffer_set_curr(basic_c_io_observer_unlocked<char_type> bciob, char_type *
							 ...
							 ptr) noexcept
{
	::fast_io::details::serenity_obuffer_set_curr(reinterpret_cast<::fast_io::details::serenity_file_model *>(bciob.fp),
												  reinterpret_cast<char *>(ptr));
}
...
{
	return ::fast_io::details::serenity_obuffer_overflow(
		reinterpret_cast<::fast_io::details::serenity_file_model *>(bciob.fp), ch);
}
