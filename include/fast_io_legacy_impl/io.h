...
inline constexpr void print(T &&t, Args &&...args)
{
    ...
    if constexpr (device_error)
    {
        ...
        constexpr bool type_error{::fast_io::operations::decay::defines::print_freestanding_params_decay_okay<
            char_type, decltype(::fast_io::io_print_forward<char_type>(::fast_io::io_print_alias(args)))...>};
...
template <typename T, typename... Args> inline constexpr void perr(T &&t, Args &&...args)
{
    constexpr bool device_error{::fast_io::operations::defines::has_output_or_io_stream_ref_define<T>};
    if constexpr (device_error)
    {
...
template <typename T, typename... Args> inline constexpr void perrln(T &&t, Args &&...args)
{
    constexpr bool device_error{::fast_io::operations::defines::has_output_or_io_stream_ref_define<T>};
    if constexpr (device_error)
    {
...
template <typename... Args> [[noreturn]] inline constexpr void panic(Args &&...args) noexcept
{
...
template <typename T, typename... Args> inline constexpr void debug_print(T &&t, Args &&...args)
{
    constexpr bool device_error{::fast_io::operations::defines::has_output_or_io_stream_ref_define<T>};
    if constexpr (device_error)
    {
...
template <typename T, typename... Args> inline constexpr void debug_println(T &&t, Args &&...args)
{
    constexpr bool device_error{::fast_io::operations::defines::has_output_or_io_stream_ref_define<T>};
    if constexpr (device_error)
    {
