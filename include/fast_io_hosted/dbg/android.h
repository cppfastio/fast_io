...
template <android_logger_family_tag fam, ::std::integral ch_type> struct basic_android_family_logger
{
...
inline constexpr basic_android_family_logger<fam, char_type>
io_value_handle(basic_android_family_logger<fam, char_type> lg) noexcept
{
    return lg;
};
...
inline constexpr bool android_smaller_than_pass_by_mem_size{sizeof(basic_android_family_logger<fam, char>) <=
                                                            (sizeof(::std::size_t) * 2)};

extern int my_android_log_write(::std::int_least32_t, char const *, char const *) noexcept
    __asm__("__android_log_write");
...
extern void my_android_log_write_log_message(android_logmessage_v30 *log_message) noexcept
    __asm__("__android_log_write_log_message");
...
{
    android_logmessage_v30 v{.buffer_id = meta->buffer_id,
...
inline constexpr auto android_dbg_impl(::std::int_least32_t priorit, char const *tg, ::std::source_location const &loc)
{
    return basic_android_logger<char_type>{.meta = {.priority = priorit,
                                                    .tag = tg,
                                                    .file = loc.file_name(),
                                                    .line = static_cast<::std::uint_least32_t>(loc.line())}};
}

} // namespace details

inline constexpr auto dbg(::std::int_least32_t priority = 4, char const *tg = "",
                          ::std::source_location loc = ::std::source_location::current()) noexcept
{
    return ::fast_io::details::android_dbg_impl<char>(priority, tg, loc);
}
inline constexpr auto wdbg(::std::int_least32_t priority = 4, char const *tg = "",
                           ::std::source_location loc = ::std::source_location::current()) noexcept
{
    return ::fast_io::details::android_dbg_impl<wchar_t>(priority, tg, loc);
}
inline constexpr auto u8dbg(::std::int_least32_t priority = 4, char const *tg = "",
                            ::std::source_location loc = ::std::source_location::current()) noexcept
{
    return ::fast_io::details::android_dbg_impl<char8_t>(priority, tg, loc);
}
inline constexpr auto u16dbg(::std::int_least32_t priority = 4, char const *tg = "",
                             ::std::source_location loc = ::std::source_location::current()) noexcept
{
    return ::fast_io::details::android_dbg_impl<char16_t>(priority, tg, loc);
}
inline constexpr auto u32dbg(::std::int_least32_t priority = 4, char const *tg = "",
                             ::std::source_location loc = ::std::source_location::current()) noexcept
{
