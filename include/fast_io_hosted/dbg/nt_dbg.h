...
template <::std::integral ch_type> struct basic_nt_dbg
{
...
template <bool iswide, ::std::size_t n> inline constexpr ::std::size_t calculate_nt_dbg_fmt_string_size() noexcept
{
    if constexpr (iswide)
    {
...
template <bool iswide, ::std::size_t n> inline constexpr auto calculate_nt_dbg_fmt() noexcept
{
...
template <bool iswide, ::std::size_t n> inline constexpr auto nt_fmt_cache{calculate_nt_dbg_fmt<iswide, n>()};
...
inline void nt_fmt_dbg_forward([[maybe_unused]] nt_dbg_carrier carr, char8_t const *fmt, io_scatter_t const *arg,
                               Args const *...args) noexcept
{
    ...
    else
    {
        ...
        ::fast_io::win32::nt::ansi_string astr{u16argnlen, u16argnlen,
                                               const_cast<char *>(reinterpret_cast<char const *>(arg_n_ptr))};
...
#else
    ::fast_io::win32::nt::DbgPrint(reinterpret_cast<char const *>(nt_fmt_cache<iswide, 1>.element),
                                   __builtin_addressof(astr));
#endif
}
