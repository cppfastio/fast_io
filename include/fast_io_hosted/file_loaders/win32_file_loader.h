...
template <win32_family family> inline win32_file_loader_return_value_t win32_load_address_impl(void *handle)
{
...
template <win32_family family, typename... Args> inline auto win32_load_file_impl(Args &&...args)
{
...
template <win32_family family> class win32_family_file_loader
{
  public:
