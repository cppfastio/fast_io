...
template <::std::integral ch_type> class basic_posix_io_observer
{
  public:
...
#if (defined(_WIN32) && !defined(__WINE__) && !defined(__BIONIC__)) || defined(__CYGWIN__)
    template <win32_family family> explicit operator basic_win32_family_io_observer<family, char_type>() const noexcept
    {
        return {details::my_get_osfile_handle(fd)};
    }
    template <nt_family family> explicit operator basic_nt_family_io_observer<family, char_type>() const noexcept
    {
        return {details::my_get_osfile_handle(fd)};
    }
#endif
...
template <::std::integral ch_type> inline constexpr posix_at_entry at(basic_posix_io_observer<ch_type> piob) noexcept
{
...
template <::std::integral ch_type>
inline constexpr basic_posix_io_observer<char>
io_bytes_stream_ref_define(basic_posix_io_observer<ch_type> other) noexcept
{
    return {other.handle};
}
...
template <::std::integral ch_type> inline posix_file_status status(basic_posix_io_observer<ch_type> piob)
{
#if (defined(_WIN32) && !defined(__WINE__) && !defined(__BIONIC__)) && !defined(__CYGWIN__)
...
#if (defined(_WIN32) && !defined(__WINE__) && !defined(__BIONIC__)) && !defined(__CYGWIN__)
template <::std::integral ch_type> inline auto redirect_handle(basic_posix_io_observer<ch_type> h) noexcept
{
...
template <posix_open_mode_text_behavior behavior> inline int open_fd_from_handle_impl(void *handle, open_mode md)
{
...
template <::std::integral ch_type> inline int open_fd_from_handle(void *handle, open_mode md)
{
...
template <bool always_terminate = false> inline int my_posix_openat(int, char const *, int, mode_t)
{
...
template <::std::integral ch_type> class basic_posix_file : public basic_posix_io_observer<ch_type>
{
  public:
    ...
    basic_posix_file(io_dup_t, basic_posix_io_observer<ch_type> piob)
        : basic_posix_io_observer<ch_type>{details::sys_dup(piob.fd)}
    {
    }
    explicit constexpr basic_posix_file(posix_file_factory &&factory) noexcept
        : basic_posix_io_observer<ch_type>{factory.fd}
    {
        factory.fd = -1;
    }
    ...
    template <nt_family family>
    explicit constexpr basic_posix_file(io_construct_t, basic_nt_family_io_observer<family, char_type> hd,
                                        open_mode m) noexcept
        : basic_posix_io_observer<char_type>{details::open_fd_from_handle<ch_type>(hd.handle, m)}
    {
    }
    template <win32_family family>
    explicit constexpr basic_posix_file(io_construct_t, basic_win32_family_io_observer<family, char_type> hd,
                                        open_mode m) noexcept
        : basic_posix_io_observer<char_type>{details::open_fd_from_handle<ch_type>(hd.handle, m)}
    {
    }
    ...
    basic_posix_file(sock_family d, sock_type t, open_mode m, sock_protocol p)
        : basic_posix_io_observer<char_type>{::fast_io::details::open_socket_impl(d, t, m, p)}
    {
    }
#endif
...
template <::std::integral ch_type> class basic_posix_pipe
{
  public:
    using char_type = ch_type;
...
#endif
#else
template <::std::integral ch_type> inline constexpr posix_io_redirection redirect(basic_posix_pipe<ch_type> &h) noexcept
{
...
template <::std::integral char_type = char> inline constexpr basic_posix_io_observer<char_type> posix_stdin()
{
    return {posix_stdin_number};
}
template <::std::integral char_type = char> inline constexpr basic_posix_io_observer<char_type> posix_stdout()
{
    return basic_posix_io_observer<char_type>{posix_stdout_number};
}
template <::std::integral char_type = char> inline constexpr basic_posix_io_observer<char_type> posix_stderr()
{
    return basic_posix_io_observer<char_type>{posix_stderr_number};
}

#if !defined(_WIN32) || defined(__WINE__)
template <::std::integral char_type = char> inline constexpr basic_posix_io_observer<char_type> native_stdin() noexcept
{
    return {posix_stdin_number};
}
template <::std::integral char_type = char> inline constexpr basic_posix_io_observer<char_type> native_stdout() noexcept
{
    return basic_posix_io_observer<char_type>{posix_stdout_number};
}
template <::std::integral char_type = char> inline constexpr basic_posix_io_observer<char_type> native_stderr() noexcept
{
    return basic_posix_io_observer<char_type>{posix_stderr_number};
}
#endif
