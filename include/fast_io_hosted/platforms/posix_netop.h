...
template <::std::integral ch_type> inline void posix_listen(basic_posix_io_observer<ch_type> h, int backlog)
{
...
template <::std::integral ch_type> inline posix_file_factory tcp_accept(basic_posix_io_observer<ch_type> h)
{
...
template <::std::integral ch_type> using basic_native_socket_io_observer = basic_posix_io_observer<ch_type>;
template <::std::integral ch_type> using basic_native_socket_file = basic_posix_file<ch_type>;
