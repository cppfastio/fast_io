...
inline constexpr win32_file_map_attribute &operator&=(win32_file_map_attribute &x, win32_file_map_attribute y) noexcept
{
    return x = x & y;
}
...
inline constexpr win32_file_map_attribute to_win32_file_map_attribute(file_map_attribute x)
{
    switch (x)
    {
        ...
        case file_map_attribute::read_only:
            return win32_file_map_attribute::read;
        case file_map_attribute::read_write:
            return win32_file_map_attribute::read | win32_file_map_attribute::write;
        case file_map_attribute::write_copy:
            return win32_file_map_attribute::write | win32_file_map_attribute::copy;
        default:
...
template <win32_family family> inline void *create_file_mapping_impl(void *handle, file_map_attribute attr)
{
...
template <win32_family family> class win32_family_memory_map_file
{
  public:
    ...
    constexpr win32_family_memory_map_file(::std::byte *addressbegin, ::std::byte *addressend)
        : address_begin{addressbegin}, address_end{addressend}
    {
    }
    win32_family_memory_map_file(nt_at_entry bf, file_map_attribute attr, ::std::size_t bytes,
                                 ::std::uintmax_t start_address = 0)
    {
        ...
        void *base_ptr{win32::MapViewOfFile(
            mapping_file.handle, static_cast<::std::uint_least32_t>(to_win32_file_map_attribute(attr)),
            start_address >> 32, static_cast<::std::uint_least32_t>(start_address), bytes)};
        if (base_ptr == nullptr)
            throw_win32_error();
    ...
    constexpr win32_family_memory_map_file(win32_family_memory_map_file &&__restrict other) noexcept
