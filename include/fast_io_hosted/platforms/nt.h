...
template <bool zw> struct nt_create_callback
{
...
template <bool zw> inline void *nt_family_create_file_impl(char16_t const *filename_cstr, open_mode_perms ompm)
{
...
template <bool zw> struct nt_family_open_file_parameter
{
...
template <bool zw> struct nt_family_open_file_kernel_parameter
{
    open_mode_perms ompm{};
#if __has_cpp_attribute(__gnu__::__always_inline__)
    [[__gnu__::__always_inline__]]
...
template <bool zw, bool kernel> struct nt_family_open_file_at_parameter
{
...
template <nt_family family> struct nt_family_at_entry : nt_at_entry
{
...
template <win32_family family, ::std::integral ch_type> class basic_win32_family_io_observer;
...
class basic_nt_family_io_observer
{
  public:
    ...
    template <nt_family family2> constexpr operator basic_nt_family_io_observer<family2, char_type>() const noexcept
    {
...
template <bool zw> inline void nt_flush_impl(void *handle)
{
    win32::nt::io_status_block block;
...
template <bool zw> inline void nt_data_sync_impl(void *handle, data_sync_flags flags [[maybe_unused]])
{
...
template <bool zw> inline void *nt_dup_impl(void *handle)
{
...
template <bool zw> inline void *nt_dup2_impl(void *handle, void *newhandle)
{
...
template <bool zw> inline void nt_truncate_impl(void *handle, ::std::uintmax_t newfilesizem)
{
...
template <bool zw> inline void nt_family_file_lock_common_impl(void *__restrict handle, flock_request_l64 &req)
{
...
template <nt_family family> struct nt_family_file_lock
{
    void *handle{};
...
template <::std::integral char_type> using basic_nt_io_observer = basic_nt_family_io_observer<nt_family::nt, char_type>;

template <::std::integral char_type> using basic_nt_file = basic_nt_family_file<nt_family::nt, char_type>;
...
template <int fd> inline void *nt_get_stdhandle() noexcept
{
...
template <::std::integral char_type = char> inline basic_nt_io_observer<char_type> nt_stdin() noexcept
{
    return {::fast_io::details::nt_get_stdhandle<0>()};
}

template <::std::integral char_type = char> inline basic_nt_io_observer<char_type> nt_stdout() noexcept
{
    return {::fast_io::details::nt_get_stdhandle<1>()};
}

template <::std::integral char_type = char> inline basic_nt_io_observer<char_type> nt_stderr() noexcept
{
    return {::fast_io::details::nt_get_stdhandle<2>()};
}

template <::std::integral char_type> using basic_zw_io_observer = basic_nt_family_io_observer<nt_family::zw, char_type>;

template <::std::integral char_type> using basic_zw_file = basic_nt_family_file<nt_family::zw, char_type>;
...
template <::std::integral char_type = char> inline basic_zw_io_observer<char_type> zw_stdin() noexcept
{
    return {::fast_io::details::nt_get_stdhandle<0>()};
}

template <::std::integral char_type = char> inline basic_zw_io_observer<char_type> zw_stdout() noexcept
{
    return {::fast_io::details::nt_get_stdhandle<1>()};
}

template <::std::integral char_type = char> inline basic_zw_io_observer<char_type> zw_stderr() noexcept
{
    return {::fast_io::details::nt_get_stdhandle<2>()};
}

#if !defined(_WIN32_WINDOWS) && 0
template <::std::integral char_type = char> inline basic_nt_io_observer<char_type> native_stdin() noexcept
{
    return {::fast_io::details::nt_get_stdhandle<0>()};
}
template <::std::integral char_type = char> inline basic_nt_io_observer<char_type> native_stdout() noexcept
{
    return {::fast_io::details::nt_get_stdhandle<1>()};
}
template <::std::integral char_type = char> inline basic_nt_io_observer<char_type> native_stderr() noexcept
{
    return {::fast_io::details::nt_get_stdhandle<2>()};
}
#endif
...
{
template <nt_family fm, ::std::integral char_type> struct is_trivially_relocatable<basic_nt_family_file<fm, char_type>>
{
