...
inline ::std::int_least64_t nt_fpos_offset_addition(::std::uint_least64_t ucurrent, ::fast_io::intfpos_t off) noexcept
{
	...
	if (l64off < 0)
	{
		::std::uint_least64_t l64abs{static_cast<::std::uint_least64_t>(static_cast<::std::uint_least64_t>(0) -
																		static_cast<::std::uint_least64_t>(l64off))};
		if (ucurrent < l64abs)
		{
			return 0;
		}
	...
	else
	{
		...
		constexpr ::std::uint_least64_t l64mx{
