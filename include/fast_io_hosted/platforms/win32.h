...
*/
template <::fast_io::win32_family family> inline ::std::size_t crypt_acquire_context_fallback()
{
    ::std::size_t hprov{};
...
template <::fast_io::win32_family family> struct win32_family_hcryptprov_guard
{
    ::std::size_t hprov{};
...
template <win32_family family> inline void *create_win32_temp_file_impl()
{
...
template <win32_family family> struct win32_family_open_file_parameter
{
...
template <win32_family family, ::std::integral ch_type> class basic_win32_family_pipe
{
  public:
    using char_type = ch_type;
...
template <::std::integral char_type> using basic_win32_file = basic_win32_family_file<win32_family::native, char_type>;
template <::std::integral char_type> using basic_win32_pipe = basic_win32_family_pipe<win32_family::native, char_type>;
...
template <::std::integral char_type = char> inline basic_win32_io_observer_9xa<char_type> win32_stdin_9xa() noexcept
{
    return {::fast_io::win32::GetStdHandle(win32_stdin_number)};
}
template <::std::integral char_type = char> inline basic_win32_io_observer_9xa<char_type> win32_stdout_9xa() noexcept
{
    return {::fast_io::win32::GetStdHandle(win32_stdout_number)};
}
template <::std::integral char_type = char> inline basic_win32_io_observer_9xa<char_type> win32_stderr_9xa() noexcept
{
    return {::fast_io::win32::GetStdHandle(win32_stderr_number)};
}

template <::std::integral char_type = char> inline basic_win32_io_observer_ntw<char_type> win32_stdin_ntw() noexcept
{
    return {::fast_io::win32::GetStdHandle(win32_stdin_number)};
}
template <::std::integral char_type = char> inline basic_win32_io_observer_ntw<char_type> win32_stdout_ntw() noexcept
{
    return {::fast_io::win32::GetStdHandle(win32_stdout_number)};
}
template <::std::integral char_type = char> inline basic_win32_io_observer_ntw<char_type> win32_stderr_ntw() noexcept
{
    return {::fast_io::win32::GetStdHandle(win32_stderr_number)};
}

template <::std::integral char_type = char> inline basic_win32_io_observer<char_type> win32_stdin() noexcept
{
    return {::fast_io::win32::GetStdHandle(win32_stdin_number)};
}
template <::std::integral char_type = char> inline basic_win32_io_observer<char_type> win32_stdout() noexcept
{
    return {::fast_io::win32::GetStdHandle(win32_stdout_number)};
}
template <::std::integral char_type = char> inline basic_win32_io_observer<char_type> win32_stderr() noexcept
{
    return {::fast_io::win32::GetStdHandle(win32_stderr_number)};
}

#if !defined(__CYGWIN__) && !defined(__WINE__)
template <::std::integral char_type = char> inline basic_win32_io_observer<char_type> native_stdin() noexcept
{
    return {::fast_io::win32::GetStdHandle(win32_stdin_number)};
}
template <::std::integral char_type = char> inline basic_win32_io_observer<char_type> native_stdout() noexcept
{
    return {::fast_io::win32::GetStdHandle(win32_stdout_number)};
}
template <::std::integral char_type = char> inline basic_win32_io_observer<char_type> native_stderr() noexcept
{
    return {::fast_io::win32::GetStdHandle(win32_stderr_number)};
}
#endif
