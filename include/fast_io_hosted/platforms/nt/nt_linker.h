...
__stdcall
#endif
NtMapViewOfSection(void*, void*, void**, ::std::size_t, ::std::size_t, large_integer const*, ::std::size_t*, section_inherit, ::std::uint_least32_t, ::std::uint_least32_t) noexcept
#if defined(__clang__) || defined(__GNUC__)
#if SIZE_MAX<=UINT_LEAST32_MAX &&(defined(__x86__) || defined(_M_IX86) || defined(__i386__))
#if !defined(__clang__)
...
__stdcall
#endif
ZwMapViewOfSection(void*, void*, void**, ::std::size_t, ::std::size_t, large_integer const*, ::std::size_t*, section_inherit, ::std::uint_least32_t, ::std::uint_least32_t) noexcept
#if defined(__clang__) || defined(__GNUC__)
#if SIZE_MAX<=UINT_LEAST32_MAX &&(defined(__x86__) || defined(_M_IX86) || defined(__i386__))
#if !defined(__clang__)
