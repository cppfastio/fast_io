...
struct rtl_unicode_string_unique_ptr
{
	...
	constexpr rtl_unicode_string_unique_ptr(unicode_string *ptr)
		: heap_ptr(ptr)
	{}
	...
	constexpr rtl_unicode_string_unique_ptr(rtl_unicode_string_unique_ptr &&__restrict other) noexcept
