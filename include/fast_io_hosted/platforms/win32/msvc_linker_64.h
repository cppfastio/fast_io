...
#pragma comment(linker,"/alternatename:__imp_?LookupPrivilegeValueA@win32@fast_io@@YAHPEBD0PEA_J@Z=__imp_LookupPrivilegeValueA")
#pragma comment(linker,"/alternatename:__imp_?LookupPrivilegeValueW@win32@fast_io@@YAHPEB_S0PEA_J@Z=__imp_LookupPrivilegeValueW")
// NT
