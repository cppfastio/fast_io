...
#pragma comment(linker,"/alternatename:__imp_?NtCreateNamedPipeFile@nt@win32@fast_io@@YAIPEIAPEAXIPEIAUobject_attributes@123@PEIAUio_status_block@123@IIIEEEIIIPEA_K@Z=__imp_NtCreateNamedPipeFile")
#pragma comment(linker,"/alternatename:__imp_?ZwCreateNamedPipeFile@nt@win32@fast_io@@YAIPEIAPEAXIPEIAUobject_attributes@123@PEIAUio_status_block@123@IIIEEEIIIPEA_K@Z=__imp_ZwCreateNamedPipeFile")
