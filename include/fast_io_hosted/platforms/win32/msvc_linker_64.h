...
#pragma comment(linker,"/alternatename:__imp_?DeviceIoControl@win32@fast_io@@YAHPEAXI0I0IPEAIPEAUoverlapped@12@@Z=__imp_DeviceIoControl")
...
#pragma comment(linker,"/alternatename:__imp_?WSADuplicateSocketA@win32@fast_io@@YAH_KIPEAUwsaprotocol_infoa@12@@Z=__imp_WSADuplicateSocketA")
#pragma comment(linker,"/alternatename:__imp_?WSADuplicateSocketW@win32@fast_io@@YAH_KIPEAUwsaprotocol_infow@12@@Z=__imp_WSADuplicateSocketW")
...
#pragma comment(linker,"/alternatename:__imp_?GetQueuedCompletionStatus@win32@fast_io@@YAHPEAXPEAIPEA_KPEAPEAUoverlapped@12@I@Z=__imp_GetQueuedCompletionStatus")
...
#pragma comment(linker,"/alternatename:__imp_?GetEnvironmentStringsW@win32@fast_io@@YAPEA_SXZ=__imp_GetEnvironmentStringsW")
#pragma comment(linker,"/alternatename:__imp_?GetEnvironmentStringsA@win32@fast_io@@YAPEADXZ=__imp_GetEnvironmentStringsA")
#pragma comment(linker,"/alternatename:__imp_?FreeEnvironmentStringsW@win32@fast_io@@YAHPEA_S@Z=__imp_FreeEnvironmentStringsW")
#pragma comment(linker,"/alternatename:__imp_?FreeEnvironmentStringsA@win32@fast_io@@YAHPEAD@Z=__imp_FreeEnvironmentStringsA")
#pragma comment(linker,"/alternatename:__imp_?getsockopt@win32@fast_io@@YAH_KHHPEADPEAH@Z=__imp_getsockopt")
#pragma comment(linker,"/alternatename:__imp_?GetFullPathNameW@win32@fast_io@@YAIPEB_SIPEA_SPEAPEA_S@Z=__imp_GetFullPathNameW")
#pragma comment(linker,"/alternatename:__imp_?GetFullPathNameA@win32@fast_io@@YAIPEBDIPEADPEAPEAD@Z=__imp_GetFullPathNameA")
#pragma comment(linker,"/alternatename:__imp_?GetVolumeInformationW@win32@fast_io@@YAHPEB_SPEA_SIPEAI221I@Z=__imp_GetVolumeInformationW")
#pragma comment(linker,"/alternatename:__imp_?GetVolumeInformationA@win32@fast_io@@YAHPEBDPEADIPEAI221I@Z=__imp_GetVolumeInformationA")
#pragma comment(linker,"/alternatename:__imp_?GetDiskFreeSpaceW@win32@fast_io@@YAHPEB_SPEAI111@Z=__imp_GetDiskFreeSpaceW")
#pragma comment(linker,"/alternatename:__imp_?GetDiskFreeSpaceA@win32@fast_io@@YAHPEBDPEAI111@Z=__imp_GetDiskFreeSpaceA")
// NT
...
#pragma comment(linker,"/alternatename:__imp_?NtSetSystemTime@nt@win32@fast_io@@YAIPEA_J0@Z=__imp_NtSetSystemTime")
#pragma comment(linker,"/alternatename:__imp_?ZwSetSystemTime@nt@win32@fast_io@@YAIPEA_J0@Z=__imp_ZwSetSystemTime")
...
#pragma comment(linker,"/alternatename:__imp_?RtlCreateUserThread@nt@win32@fast_io@@YAIPEAX0HI_K1P6AI0@Z0PEAPEAXPEAUclient_id@123@@Z=__imp_RtlCreateUserThread")
...
#pragma comment(linker,"/alternatename:__imp_?RtlAcquirePebLock@nt@win32@fast_io@@YAXXZ=__imp_RtlAcquirePebLock")
#pragma comment(linker,"/alternatename:__imp_?RtlReleasePebLock@nt@win32@fast_io@@YAXXZ=__imp_RtlReleasePebLock")
...
#pragma comment(linker,"/alternatename:__imp_?RtlInitUnicodeString@nt@win32@fast_io@@YAXPEAUunicode_string@123@PEA_S@Z=__imp_RtlInitUnicodeString")
...
#pragma comment(linker,"/alternatename:__imp_?RtlTryAcquireSRWLockExclusive@nt@win32@fast_io@@YAEPEAX@Z=__imp_RtlTryAcquireSRWLockExclusive")
...
#pragma comment(linker,"/alternatename:__imp_?RtlGetSystemTimePrecise@nt@win32@fast_io@@YA_KXZ=__imp_RtlGetSystemTimePrecise")
