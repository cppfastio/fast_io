...
#pragma comment(linker,"/alternatename:__imp_?DeviceIoControl@win32@fast_io@@YAHPAXI0I0IPAIPAUoverlapped@12@@Z=__imp_DeviceIoControl")
...
#pragma comment(linker,"/alternatename:__imp_?WSADuplicateSocketA@win32@fast_io@@YAHIIPAUwsaprotocol_infoa@12@@Z=__imp_WSADuplicateSocketA")
#pragma comment(linker,"/alternatename:__imp_?WSADuplicateSocketW@win32@fast_io@@YAHIIPAUwsaprotocol_infow@12@@Z=__imp_WSADuplicateSocketW")
...
#pragma comment(linker,"/alternatename:__imp_?GetQueuedCompletionStatus@win32@fast_io@@YAHPAXPAI1PAPAUoverlapped@12@I@Z=__imp_GetQueuedCompletionStatus")
...
#pragma comment(linker,"/alternatename:__imp_?GetEnvironmentStringsW@win32@fast_io@@YAPA_SXZ=__imp_GetEnvironmentStringsW")
#pragma comment(linker,"/alternatename:__imp_?GetEnvironmentStringsA@win32@fast_io@@YAPADXZ=__imp_GetEnvironmentStringsA")
#pragma comment(linker,"/alternatename:__imp_?FreeEnvironmentStringsW@win32@fast_io@@YAHPA_S@Z=__imp_FreeEnvironmentStringsW")
#pragma comment(linker,"/alternatename:__imp_?FreeEnvironmentStringsA@win32@fast_io@@YAHPAD@Z=__imp_FreeEnvironmentStringsA")
#pragma comment(linker,"/alternatename:__imp_?getsockopt@win32@fast_io@@YAHIHHPADPAH@Z=__imp_getsockopt")
#pragma comment(linker,"/alternatename:__imp_?GetFullPathNameW@win32@fast_io@@YAIPB_SIPA_SPAPA_S@Z=__imp_GetFullPathNameW")
#pragma comment(linker,"/alternatename:__imp_?GetFullPathNameA@win32@fast_io@@YAIPBDIPADPAPAD@Z=__imp_GetFullPathNameA")
#pragma comment(linker,"/alternatename:__imp_?GetVolumeInformationW@win32@fast_io@@YAHPB_SPA_SIPAI221I@Z=__imp_GetVolumeInformationW")
#pragma comment(linker,"/alternatename:__imp_?GetVolumeInformationA@win32@fast_io@@YAHPBDPADIPAI221I@Z=__imp_GetVolumeInformationA")
#pragma comment(linker,"/alternatename:__imp_?GetDiskFreeSpaceW@win32@fast_io@@YAHPB_SPAI111@Z=__imp_GetDiskFreeSpaceW")
#pragma comment(linker,"/alternatename:__imp_?GetDiskFreeSpaceA@win32@fast_io@@YAHPBDPAI111@Z=__imp_GetDiskFreeSpaceA")
// NT
...
#pragma comment(linker,"/alternatename:__imp_?NtSetSystemTime@nt@win32@fast_io@@YAIPA_J0@Z=__imp_NtSetSystemTime")
#pragma comment(linker,"/alternatename:__imp_?ZwSetSystemTime@nt@win32@fast_io@@YAIPA_J0@Z=__imp_ZwSetSystemTime")
...
#pragma comment(linker,"/alternatename:__imp_?RtlInitUnicodeString@nt@win32@fast_io@@YAXPAUunicode_string@123@PA_S@Z=__imp_RtlInitUnicodeString")
...
#pragma comment(linker,"/alternatename:__imp_?RtlTryAcquireSRWLockExclusive@nt@win32@fast_io@@YAEPAX@Z=__imp_RtlTryAcquireSRWLockExclusive")
