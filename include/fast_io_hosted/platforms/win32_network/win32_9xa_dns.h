...
inline constexpr ::fast_io::ip_address hostent_to_ip_address_impl(::fast_io::win32::hostent *ent,
...
inline constexpr ::fast_io::ip hostent_to_ip_impl(::fast_io::win32::hostent *ent, ::std::size_t pos,
...
class win32_9xa_dns_io_observer
{
public:
...
inline constexpr ::fast_io::ip to_ip(win32_9xa_dns_io_observer d, ::std::uint_least16_t port) noexcept
{
	return ::fast_io::details::hostent_to_ip_impl(d.res, 0u, port);
}

inline constexpr ::fast_io::ip_address to_ip_address(win32_9xa_dns_io_observer d) noexcept
{
	return ::fast_io::details::hostent_to_ip_address_impl(d.res, 0u);
}

struct win32_9xa_dns_iterator
{
	using native_handle_type = ::fast_io::win32::hostent *;
	native_handle_type res{};
	::std::size_t pos{};
...
inline constexpr win32_9xa_dns_iterator operator++(win32_9xa_dns_iterator d, int) noexcept
{
	auto temp{d};
	++d;
	return temp;
...
inline constexpr win32_9xa_dns_iterator begin(win32_9xa_dns_io_observer w9xniob) noexcept
{
	return {w9xniob.res, 0u};
}

inline constexpr win32_9xa_dns_iterator cbegin(win32_9xa_dns_io_observer w9xniob) noexcept
{
	return {w9xniob.res, 0u};
}

inline constexpr ::std::default_sentinel_t end(win32_9xa_dns_io_observer) noexcept
{
	return {};
}

inline constexpr ::std::default_sentinel_t cend(win32_9xa_dns_io_observer) noexcept
{
	return {};
}
...
class win32_9xa_dns_file : public win32_9xa_dns_io_observer
{
public:
	using native_handle_type = typename win32_9xa_dns_io_observer::native_handle_type;
	inline constexpr win32_9xa_dns_file() noexcept = default;
	template <typename native_hd>
		requires ::std::same_as<native_handle_type, ::std::remove_cvref_t<native_hd>>
	inline explicit constexpr win32_9xa_dns_file(native_hd res1) noexcept
		: win32_9xa_dns_io_observer{res1}
	{
	}
	inline explicit constexpr win32_9xa_dns_file(decltype(nullptr)) noexcept = delete;

	inline constexpr win32_9xa_dns_file(win32_9xa_dns_io_observer) noexcept = delete;
	inline constexpr win32_9xa_dns_file &operator=(win32_9xa_dns_io_observer) noexcept = delete;
