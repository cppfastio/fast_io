...
template <win32_family family, ::std::integral ch_type> class basic_win32_family_socket_io_observer
{
  public:
...
template <win32_family family> inline ::std::size_t win32_family_tcp_connect_v4_impl(ipv4 v4, open_mode m)
{
...
template <win32_family family> inline ::std::size_t win32_family_tcp_connect_v6_impl(ipv6 v6, open_mode m)
{
...
template <win32_family family> inline ::std::size_t win32_family_tcp_connect_ip_impl(ip v, open_mode m)
{
...
template <win32_family family> inline ::std::size_t win32_tcp_listen_impl(::std::uint_least16_t port, open_mode m)
{
    basic_win32_family_socket_file<family, char> soc(sock_family::inet, sock_type::stream, m, sock_protocol::tcp);
...
template <win32_family family> inline win32_socket_factory win32_family_tcp_connect(ipv4 v4, open_mode m = open_mode{})
{
...
template <win32_family family> inline win32_socket_factory win32_family_tcp_connect(ipv6 v6, open_mode m = open_mode{})
{
...
template <::std::integral ch_type> using basic_native_socket_io_observer = basic_win32_socket_io_observer<ch_type>;
template <::std::integral ch_type> using basic_native_socket_file = basic_win32_socket_file<ch_type>;
