...
namespace details
{
inline constexpr ::fast_io::ip_address win32_to_ip_address_with_ai_addr_impl(int ai_family,
    ...
    switch (ai_family)
    {
        case 2: {
            ::fast_io::details::my_memcpy(
                __builtin_addressof(ret.address.v4),
        ...
        case 23: {
            ::fast_io::details::my_memcpy(
                __builtin_addressof(ret.address.v6),
...
inline constexpr ::fast_io::ip win32_to_ip_with_ai_addr_impl(int ai_family, posix_sockaddr const *ai_addr,
...
template <win32_family fam>
inline ::fast_io::win32::win32_family_addrinfo<fam> *
...
template <win32_family fam> struct win32_family_dns_open_parameter
{
...
template <win32_family fam> class win32_family_dns_file : public win32_family_dns_io_observer<fam>
{
  public:
...
template <win32_family fam> inline constexpr ::std::default_sentinel_t end(win32_family_dns_io_observer<fam>) noexcept
{
    return {};
}

template <win32_family fam> inline constexpr ::std::default_sentinel_t cend(win32_family_dns_io_observer<fam>) noexcept
{
    return {};
}
