...
template <typename input, ::std::size_t N>
concept minimum_buffer_input_stream_require_size_impl =
...
template <::std::integral ch_type> inline int random_entropy(basic_posix_io_observer<ch_type> piob) noexcept
{
...
using basic_ibuf_white_hole =
    basic_io_buffer<basic_native_white_hole<char_type>,
                    ::fast_io::basic_io_buffer_traits<buffer_mode::in | buffer_mode::secure_clear, allocator_type,
                                                      char_type, void, 8192u, 0>>;
...
template <typename handletype> struct basic_white_hole_engine
{
