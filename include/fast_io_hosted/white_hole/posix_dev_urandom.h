...
template <typename handletype, ::std::integral chtype> class basic_generic_posix_dev_urandom
{
  public:
...
template <typename observetype, ::std::integral chtype> class basic_generic_posix_dev_urandom_ref : public observetype
{
  public:
    ...
    explicit constexpr basic_generic_posix_dev_urandom_ref(native_handle_type hd) noexcept : observer_type{hd} {}
};

template <typename handletype, ::std::integral char_type>
inline constexpr auto io_stream_ref_define(basic_generic_posix_dev_urandom<handletype, char_type> &pdur) noexcept
{
    return basic_generic_posix_dev_urandom_ref<
        typename basic_generic_posix_dev_urandom<handletype, char_type>::observer_type, char_type>{
        pdur.handle.native_handle()};
}

template <typename observetype, ::std::integral char_type>
inline constexpr basic_generic_posix_dev_urandom_ref<observetype, char_type>
io_stream_ref_define(basic_generic_posix_dev_urandom_ref<observetype, char_type> pdur) noexcept
{
    return pdur;
}
...
using basic_posix_dev_urandom = basic_generic_posix_dev_urandom<::fast_io::basic_posix_file<char_type>, char_type>;

template <::std::integral char_type>
using basic_posix_dev_urandom_ref =
    basic_generic_posix_dev_urandom_ref<typename basic_posix_dev_urandom<char_type>::observer_type, char_type>;
