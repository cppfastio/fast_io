...
template <async_output_stream stm, bool line> class async_print_coroutine
{
  public:
    typename io_async_scheduler_t<stm>::type &scheduler;
    stm &stream;
...
constexpr inline details::async_io_coroutine<stm, Iter, false>
async_read(typename io_async_scheduler_t<stm>::type &scheduler, stm &sm, Iter begin, Iter end,
...
constexpr inline details::async_io_coroutine<stm, Iter, true>
async_write(typename io_async_scheduler_t<stm>::type &scheduler, stm &sm, Iter begin, Iter end,
...
constexpr inline details::async_scatter_io_coroutine<stm, false>
async_scatter_read(typename io_async_scheduler_t<stm>::type &scheduler, stm &sm, ::std::span<io_scatter_t> sc,
                   ::std::ptrdiff_t offset = 0)
{
...
constexpr inline details::async_scatter_io_coroutine<stm, true>
async_scatter_write(typename io_async_scheduler_t<stm>::type &scheduler, stm &sm, ::std::span<io_scatter_t> sc,
                    ::std::ptrdiff_t offset = -1)
{
    return {scheduler, sm, sc, offset};
}
...
constexpr inline details::async_print_coroutine<stm, false>
async_print(typename io_async_scheduler_t<stm>::type &scheduler, stm &sm, Args &&...args)
{
    return details::async_print_coroutine<stm, false>(scheduler, -1, sm, ::std::forward<Args>(args)...);
}
template <async_output_stream stm, typename... Args>
constexpr inline details::async_print_coroutine<stm, true>
async_println(typename io_async_scheduler_t<stm>::type &scheduler, stm &sm, Args &&...args)
{
...
template <async_output_stream stm, typename... Args>
constexpr inline details::async_print_coroutine<stm, false>
async_print(typename io_async_scheduler_t<stm>::type &scheduler, ::std::ptrdiff_t offset, stm &sm, Args &&...args)
{
    return details::async_print_coroutine<stm, false>(scheduler, offset, sm, ::std::forward<Args>(args)...);
}
template <async_output_stream stm, typename... Args>
constexpr inline details::async_print_coroutine<stm, true>
async_println(typename io_async_scheduler_t<stm>::type &scheduler, ::std::ptrdiff_t offset, stm &sm, Args &&...args)
{
