...
namespace fast_io
{
template <typename Allocator> struct basic_nt_api_encoding_converter
{
    ...
    constexpr
        ...
        : buffer_capacity(details::cal_decorated_reserve_size<sizeof(from_char_type), sizeof(char_type)>(sz)),
          buffer_data(details::allocate_iobuf_space<char_type, allocator_type>(
              details::intrinsics::add_or_overflow_die(buffer_capacity, 1))),
    ...
    constexpr
        ...
        : buffer_capacity(sz), buffer_data(details::allocate_iobuf_space<char_type, allocator_type>(
                                   ::fast_io::details::intrinsics::add_or_overflow_die(sz, 1))),
          buffer_data_end(details::codecvt::general_code_cvt_full(p, p + sz, buffer_data))
    {
        *buffer_data_end = 0;
    }
...
using nt_api_encoding_converter =
    basic_nt_api_encoding_converter<generic_allocator_adapter<::fast_io::nt_rtlallocateheap_allocator>>;
#endif
} // namespace fast_io