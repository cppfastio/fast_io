...
inline constexpr cross_code_cvt_t<char8_t> print_alias_define(::fast_io::io_alias_t,
															  posix_timezone_name const &enm) noexcept
{
	...
	{
		return ::fast_io::cross_code_cvt_t<char8_t>{{enm.ptr + ::fast_io::details::localtimezoneinfo_string_len,
													 enm.n - ::fast_io::details::localtimezoneinfo_string_len}};
	}
}
