...
template <bool is_thread> inline unix_timestamp win32_posix_clock_gettime_process_or_thread_time_impl()
{
...
{
#if !defined(_WIN32) || defined(__CYGWIN__)
template <bool local_tm> inline struct tm unix_timestamp_to_tm_impl(::std::int_least64_t seconds)
{
