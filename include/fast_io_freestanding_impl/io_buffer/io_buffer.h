...
template <typename T> inline constexpr void close_basic_io_buffer(T &);
template <typename T> inline constexpr void clear_basic_io_buffer_pointers(T &) noexcept;
template <typename T> inline constexpr void destroy_basic_io_buffer(T &) noexcept;
...
template <typename handletype, typename iobuffertraits> class basic_io_buffer
{
  public:
