...
template <typename T> inline constexpr void close_basic_io_buffer(T &t)
{
...
template <typename T> inline constexpr void clear_basic_io_buffer_pointers(T &t) noexcept
{
    using traits_type = typename T::traits_type;
    constexpr auto mode{traits_type::mode};
    if constexpr ((mode & buffer_mode::out) == buffer_mode::out)
...
template <typename T> inline constexpr void destroy_basic_io_buffer(T &t) noexcept
{
    using traits_type = typename T::traits_type;
