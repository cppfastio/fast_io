...
inline constexpr ::std::size_t compute_transcode_buffer_size(::std::size_t oldbuffersize,::std::size_t oldchartypesize,::std::size_t newchartypesize) noexcept
{
...
inline constexpr auto io_stream_transcode_deco_filter_define(
	...
	dectref &&deco)
{
	using newtype = decltype(io_stream_transcode_deco_filter_define(io_stream_transcode_deco_filter_ref_define(::fast_io::freestanding::move(rf.iobptr->handle)),deco));
	return ::fast_io::basic_io_buffer<newtype,::fast_io::basic_io_buffer_traits<iobuffertraits::mode,
		typename iobuffertraits::allocator_type,
		typename newtype::input_char_type,
		typename newtype::output_char_type,
		::fast_io::details::compute_transcode_buffer_size(iobuffertraits::input_buffer_size,sizeof(typename newtype::input_char_type),sizeof(typename iobuffertraits::input_char_type)),
		::fast_io::details::compute_transcode_buffer_size(iobuffertraits::output_buffer_size,sizeof(typename newtype::output_char_type),sizeof(typename iobuffertraits::input_char_type))>>(io_stream_transcode_deco_filter_define(io_stream_transcode_deco_filter_ref_define(::fast_io::freestanding::move(rf.iobptr->handle)),deco));
}
...
requires ((iobuffertraits::mode&buffer_mode::out)==buffer_mode::out)
inline constexpr auto
	output_stream_deco_filter_ref_define(basic_io_buffer_transcode_ref<basic_io_buffer<handletype,iobuffertraits>> r) noexcept
{
	return r;
}
...
requires ((iobuffertraits::mode&buffer_mode::in)==buffer_mode::in)
inline constexpr auto
	input_stream_deco_filter_ref_define(basic_io_buffer_transcode_ref<basic_io_buffer<handletype,iobuffertraits>> r) noexcept
{
	return r;
}
