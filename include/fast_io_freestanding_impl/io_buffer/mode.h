...
template <typename T> struct basic_io_buffer_pointers
{
    using value_type = T;
    using pointer = T *;
...
template <typename T> struct basic_io_buffer_pointers_no_curr
{
    using value_type = T;
    using pointer = T *;
...
template <typename char_type> constexpr ::std::size_t compute_default_buffer_size() noexcept
{
