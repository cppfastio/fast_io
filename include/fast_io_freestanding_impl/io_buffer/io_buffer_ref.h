...
inline constexpr basic_io_buffer_ref<basic_io_buffer<handletype,iobuffertraits>>
	io_stream_ref_define(basic_io_buffer<handletype,iobuffertraits> &r)
{
...
inline constexpr basic_io_buffer_ref<basic_io_buffer<handletype,iobuffertraits>> output_stream_ref_define(basic_io_buffer<handletype,iobuffertraits> &r)
{
	return {__builtin_addressof(r)};
}
...
inline constexpr basic_io_buffer_ref<basic_io_buffer<handletype,iobuffertraits>> input_stream_ref_define(
	basic_io_buffer_ref<basic_io_buffer<handletype,iobuffertraits>> &r)
{
	return {__builtin_addressof(r)};
}
