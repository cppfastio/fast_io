...
template <typename inputdeco, typename outputdeco> struct basic_bidirectional_decorator_adaptor
{
...
template <typename T> struct basic_bidirectional_decorator_adaptor_ref
{
    ...
    output_process_chars(input_char_type const *fromfirst, input_char_type const *fromlast, output_char_type *tofirst,
    ...
    input_process_chars(output_char_type const *fromfirst, output_char_type const *fromlast, input_char_type *tofirst,
                        input_char_type *tolast)
    {
        return bdoaptr->idecorator.process_chars(fromfirst, fromlast, tofirst, tolast);
    }
};

template <typename inputdeco, typename outputdeco>
