...
template <typename T> inline constexpr auto width(scalar_placement placement, T &&t, ::std::size_t n) noexcept
{
...
template <typename T> inline constexpr auto left(T &&t, ::std::size_t n) noexcept
{
    using noref = ::std::remove_cvref_t<T>;
    if constexpr (alias_printable<::std::remove_cvref_t<T>>)
    {
...
template <typename T> inline constexpr auto middle(T &&t, ::std::size_t n) noexcept
{
    using noref = ::std::remove_cvref_t<T>;
    if constexpr (alias_printable<::std::remove_cvref_t<T>>)
    {
...
template <typename T> inline constexpr auto right(T &&t, ::std::size_t n) noexcept
{
    using noref = ::std::remove_cvref_t<T>;
    if constexpr (alias_printable<::std::remove_cvref_t<T>>)
    {
...
template <typename T> inline constexpr auto internal(T &&t, ::std::size_t n) noexcept
{
    using noref = ::std::remove_cvref_t<T>;
    if constexpr (alias_printable<::std::remove_cvref_t<T>>)
    {
