...
template <std::integral char_type, ::fast_io::details::my_integral I>
inline constexpr parse_code scan_context_eof_define(io_reserve_type_t<char_type, manipulators::basic_leb128_get_put<I>>, leb128_scan_state_t& state, manipulators::basic_leb128_get_put<I>) noexcept
{
