...
template <typename value_type> struct basic_leb128_get_put
{
...
template <::fast_io::details::my_integral T> inline constexpr auto leb128_put(T t) noexcept
{
...
template <::fast_io::details::my_integral T> inline constexpr auto leb128_get(T &t) noexcept
{
...
template <::fast_io::details::my_integral T> inline constexpr ::std::size_t print_reserve_size_leb128_length() noexcept
{
    constexpr ::std::size_t digits{::std::numeric_limits<char unsigned>::digits * sizeof(T)};
...
print_reserve_define(io_reserve_type_t<char_type, ::fast_io::manipulators::basic_leb128_get_put<T>>, char_type *iter,
...
inline constexpr io_type_t<leb128_scan_state_t>
scan_context_type(io_reserve_type_t<char_type, manipulators::basic_leb128_get_put<I>>) noexcept
{
    return {};
}
...
scn_ctx_define_leb128_impl(::std::size_t &group_count, char_type const *begin, char_type const *end, I &t) noexcept
{
    using unsigned_char_type = ::std::make_unsigned_t<char_type>;
...
template <::std::integral char_type, ::fast_io::details::my_integral I>
inline constexpr parse_result<char_type const *> scn_cnt_define_leb128_impl(char_type const *begin,
                                                                            char_type const *end, I &t) noexcept
{
    using unsigned_char_type = ::std::make_unsigned_t<char_type>;
    using U = ::fast_io::details::my_make_unsigned_t<I>;
    constexpr auto digits{::std::numeric_limits<U>::digits};
...
template <::std::integral char_type, ::fast_io::details::my_integral I>
inline constexpr parse_result<char_type const *>
scan_context_define(io_reserve_type_t<char_type, manipulators::basic_leb128_get_put<I *>>, leb128_scan_state_t &state,
                    char_type const *begin, char_type const *end, manipulators::basic_leb128_get_put<I *> t) noexcept
{
...
template <::std::integral char_type, ::fast_io::details::my_integral I>
inline constexpr parse_result<char_type const *>
scan_contiguous_define(io_reserve_type_t<char_type, manipulators::basic_leb128_get_put<I *>>, char_type const *begin,
                       char_type const *end, manipulators::basic_leb128_get_put<I *> t) noexcept
{
