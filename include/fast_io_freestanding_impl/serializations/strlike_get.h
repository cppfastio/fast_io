...
template <typename T> struct basic_strlike_get
{
    using value_type = T;
...
template <typename T> inline constexpr auto strlike_get(T &reference) noexcept
{
...
template <typename T> inline constexpr auto strlike_line_get(T &reference) noexcept
{
    return ::fast_io::manipulators::scalar_manip_t<
...
template <typename T> inline constexpr auto strlike_whole_get(T &reference) noexcept
{
