...
template <typename T> inline constexpr ::std::size_t cal_size_lebe_floatsize() noexcept
{
...
template <::std::size_t sz, typename value_type> struct basic_lebe_get_integral
{
    value_type *pointer;
};

template <::std::size_t sz, typename value_type> struct basic_lebe_put_integral
{
...
template <::std::endian end, typename value_type> struct basic_lebe_get_put
{
    using manip_tag = manip_tag_t;
#ifndef __INTELLISENSE__
#if __has_cpp_attribute(msvc::no_unique_address)
...
template <::std::endian en, ::std::floating_point T> inline constexpr auto iec559_lebe_put(T t)
{
...
*/
template <::std::floating_point T> inline constexpr auto iec559_le_put(T t)
{
    return ::fast_io::manipulators::iec559_lebe_put<::std::endian::little>(t);
}

template <::std::floating_point T> inline constexpr auto iec559_be_put(T t)
{
...
template <::std::floating_point T> inline constexpr auto iec559_le_get(T &t)
{
    return ::fast_io::manipulators::iec559_lebe_get<::std::endian::little>(t);
}

template <::std::floating_point T> inline constexpr auto iec559_be_get(T &t)
{
...
template <typename int_type> struct parse_lebeget_int_result
{
    bool failed;
    int_type itp;
};
