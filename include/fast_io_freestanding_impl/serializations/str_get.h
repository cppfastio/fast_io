...
template <typename T> struct basic_str_get_all
{
...
template <typename T> inline constexpr auto str_get_all(T &reference, ::std::size_t n) noexcept
{
...
scan_context_define_str_get_all_buffer_common_impl(char_type const *first, char_type const *last,
                                                   io_strlike_reference_wrapper<char_type, T> output, ::std::size_t n)
{
...
template <::std::integral char_type, typename T>
inline constexpr parse_result<char_type const *>
scan_context_define_str_get_all_buffer_strlike_impl(char_type const *first, char_type const *last,
                                                    io_strlike_reference_wrapper<char_type, T> output, ::std::size_t n,
                                                    bool &ctx)
{
    if (!ctx)
...
template <::std::integral char_type, typename T>
inline constexpr parse_result<char_type const *>
scan_context_define_str_get_all_general_strlike_impl(char_type const *first, char_type const *last,
                                                     io_strlike_reference_wrapper<char_type, T> output, ::std::size_t n,
...
inline constexpr parse_result<char_type const *> scan_context_define(
    ...
    ctxtype &ctx, char_type const *first, char_type const *last,
    ::fast_io::manipulators::basic_str_get_all<io_strlike_reference_wrapper<char_type, T>> str)
{
    ...
    {
        return ::fast_io::details::scan_context_define_str_get_all_buffer_strlike_impl(first, last, str.reference,
                                                                                       str.n, ctx.copying);
    }
    else
    {
        return ::fast_io::details::scan_context_define_str_get_all_general_strlike_impl(first, last, str.reference,
                                                                                        str.n, ctx);
    }
}
