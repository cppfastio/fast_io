...
template <::std::integral char_type> struct basic_line_scanner_buffer
{
    struct buffer_type
    {
        char_type *begin_ptr{};
...
template <::std::integral char_type> struct basic_line_scanner_contiguous_view
{
    char_type const *view_begin_ptr{};
    char_type const *view_end_ptr{};
    constexpr char_type const *begin() const noexcept
...
[[__gnu__::__cold__]]
#endif
inline constexpr void copy_to_next_line_buffer_internal_impl(basic_line_scanner_buffer<char_type> &__restrict buf,
                                                             char_type const *first, ::std::size_t sz) noexcept
{
...
template <::std::integral char_type>
inline constexpr void copy_to_next_line_buffer_impl(basic_line_scanner_buffer<char_type> &__restrict buf,
...
scan_iterative_next_line_define_partial(basic_line_scanner_buffer<char_type> &__restrict buf, char_type const *first,
...
#endif
inline constexpr parse_result<char_type const *>
scan_iterative_next_line_define_inbuffer(basic_line_scanner_buffer<char_type> &__restrict buf, char_type const *first,
                                         char_type const *it) noexcept
{
...
template <::std::integral char_type>
inline constexpr parse_result<char_type const *>
scan_iterative_next_line_define_impl(basic_line_scanner_buffer<char_type> &__restrict buf, char_type const *first,
                                     char_type const *last) noexcept
{
...
template <::std::integral char_type>
inline constexpr parse_result<char_type const *>
scan_iterative_contiguous_line_define_impl(basic_line_scanner_contiguous_view<char_type> &__restrict buf,
                                           char_type const *first, char_type const *last) noexcept
{
    auto it{::fast_io::find_lf(first, last)};
    if (it == last) [[unlikely]]
...
template <::std::integral char_type>
inline constexpr parse_result<char_type const *>
scan_iterative_next_define(io_reserve_type_t<char_type, basic_line_scanner_buffer<char_type>>,
                           basic_line_scanner_buffer<char_type> &__restrict buf, char_type const *first,
                           char_type const *last) noexcept
{
...
template <::std::integral char_type>
inline constexpr parse_result<char_type const *>
scan_iterative_contiguous_define(io_reserve_type_t<char_type, basic_line_scanner_contiguous_view<char_type>>,
                                 basic_line_scanner_contiguous_view<char_type> &__restrict buf, char_type const *first,
                                 char_type const *last) noexcept
{
    return ::fast_io::details::scan_iterative_contiguous_line_define_impl(buf, first, last);
}

template <input_stream input> inline constexpr auto line_scanner(input &&in) noexcept(noexcept(io_ref(in)))
{
