...
template <typename T> inline constexpr bool print_alias_test_codecvt_impl() noexcept
{
...
template <encoding_scheme src_scheme, encoding_scheme dst_scheme, ::std::integral char_type> struct code_cvt_t
{
