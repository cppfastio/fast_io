...
template <::std::integral char_type> inline constexpr encoding_scheme execution_charset_encoding_scheme() noexcept
{
...
template <::std::integral src_char_type, ::std::integral dest_char_type> struct code_cvt_result
{
...
template <::std::integral T> struct advance_with_big_table_unchecked_result
{
    T const *src;
    char32_t cdpt;
};
...
template <::std::integral T> struct advance_with_big_table_result
{
    bool failed;
    T const *src;
    char32_t cdpt;
