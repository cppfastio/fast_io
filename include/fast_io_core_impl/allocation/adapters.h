...
template <typename alloc> inline constexpr ::std::size_t calculate_default_alignment() noexcept
{
...
template <typename alloc> class generic_allocator_adapter
{
  public:
...
template <typename alloc, typename T> class typed_generic_allocator_adapter
{
  public:
