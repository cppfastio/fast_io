...
concept transcoder = ::std::integral<fromchtype> && ::std::integral<tochtype> &&
					 requires(T t, fromchtype const *fromfirst, fromchtype const *fromlast,
							  tochtype *tofirst, tochtype *tolast, ::std::size_t imsize) {
						 { t.transcode_size(fromfirst, fromlast, imsize) } -> ::std::same_as<::std::size_t>;
...
concept eof_transcoder = transcoder<T, fromchtype, tochtype> &&
						 requires(T t, fromchtype const *fromfirst, fromchtype const *fromlast,
								  tochtype *tofirst, tochtype *tolast, ::std::size_t imsize) {
							 { t.transcode_eof_size(fromfirst, fromlast, imsize) } -> ::std::same_as<::std::size_t>;
...
concept byte_transcoder = requires(T t, ::std::byte const *fromfirst, ::std::byte const *fromlast,
								   ::std::byte *tofirst, ::std::byte *tolast, ::std::size_t imsize) {
	{ t.transcode_bytes_size(fromfirst, fromlast, imsize) } -> ::std::same_as<::std::size_t>;
...
concept byte_eof_transcoder = byte_transcoder<T> &&
							  requires(T t, ::std::byte const *fromfirst, ::std::byte const *fromlast,
									   ::std::byte *tofirst, ::std::byte *tolast, ::std::size_t imsize) {
								  { t.transcode_bytes_eof_size(fromfirst, fromlast, imsize) } -> ::std::same_as<::std::size_t>;
