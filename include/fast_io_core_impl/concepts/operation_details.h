...
concept constructible_to_os_c_str =
    type_has_c_str_method<T> || (::std::is_array_v<::std::remove_reference_t<T>>) || requires(T &&t) {
        { t.length() };
        { t.substr() };
        { t.data() };
    };
...
template <::std::integral ch_type> struct basic_os_c_str
{
...
template <::std::integral char_type> inline constexpr basic_os_c_str<char_type> os_c_str(char_type const *cstr) noexcept
{
    return {cstr};
}
...
template <::std::integral ch_type> struct basic_os_c_str_or_nullptr
{
    using char_type = ch_type;
    char_type const *ptr{};
    inline constexpr char_type const *c_str() const noexcept
...
template <::std::integral ch_type> struct basic_os_c_str_with_known_size
{
    using char_type = ch_type;
    char_type const *ptr{};
    ::std::size_t n{};
...
template <::std::integral ch_type> struct basic_os_str_known_size_without_null_terminated
{
    using char_type = ch_type;
    char_type const *ptr{};
    ::std::size_t n{};
