...
template <typename T>
concept has_input_stream_deco_filter_ref_define = requires(T &&t) { input_stream_deco_filter_ref_define(t); };

template <typename T>
concept has_output_stream_deco_filter_ref_define = requires(T &&t) { output_stream_deco_filter_ref_define(t); };

template <typename T>
concept has_io_stream_deco_filter_ref_define = requires(T &&t) { io_stream_deco_filter_ref_define(t); };
...
{
	::fast_io::operations::decay::add_output_decos_decay(::fast_io::operations::output_stream_deco_filter_ref(t),
														 args...);
}
...
{
	::fast_io::operations::decay::add_input_decos_decay(::fast_io::operations::input_stream_deco_filter_ref(t),
														args...);
}
...
{
	::fast_io::operations::decay::add_io_decos_decay(::fast_io::operations::io_stream_deco_filter_ref(t), args...);
}
