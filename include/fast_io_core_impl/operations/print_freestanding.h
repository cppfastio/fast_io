...
template <::std::integral char_type> struct basic_reserve_scatters_define_byte_result
{
...
template <::std::integral char_type> inline constexpr bool print_next_is_reserve() noexcept
{
    return false;
}
