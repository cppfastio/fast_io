		...
		::std::byte const *fromfirst, ::std::byte const *fromlast)
{
	...
	else if constexpr(::fast_io::operations::decay::defines::has_transcode_tosize_decay_define<T>)
	{
		...
		return transcode_tosize_decay_define(t,reinterpret_cast<from_may_alias_const_ptr>(fromfirst),
				reinterpret_cast<from_may_alias_const_ptr>(fromfirst)+static_cast<::std::size_t>(fromlast-fromfirst)/sizeof(from_value_type))*sizeof(to_value_type);
	}
	else if constexpr(::fast_io::operations::decay::defines::has_transcode_bytes_imaginary_decay_define<T>||
				::fast_io::operations::decay::defines::has_transcode_imaginary_decay_define<T>)
	{
		constexpr
			::std::size_t bfminsz{::fast_io::operations::decay::transcode_bytes_min_tosize_decay(::fast_io::transcode_reserve<T>)};
		constexpr
			::std::size_t mxsz{::std::numeric_limits<::std::size_t>::max()/2};
...
template <typename T>
requires ((sizeof(typename T::from_value_type)==1&&sizeof(typename T::to_value_type)==1
		...
		typename T::from_value_type const *fromfirst, typename T::from_value_type const *fromlast)
{
	if constexpr(::fast_io::operations::decay::defines::has_transcode_tosize_decay_define<T>)
	{
		...
		{
			constexpr
				::std::size_t mxsz{::std::numeric_limits<::std::size_t>::max()/sizeof(typename T::to_value_type)};
	...
	{
		constexpr
			::std::size_t bfminsz{::fast_io::operations::decay::transcode_min_tosize_decay(::fast_io::transcode_reserve<T>)};
		constexpr
			::std::size_t mxsz{::std::numeric_limits<::std::size_t>::max()/2/sizeof(typename T::to_value_type)};
		for(::std::size_t n{bfminsz};;)
		{
