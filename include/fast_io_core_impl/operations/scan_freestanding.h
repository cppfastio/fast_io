...
template <bool> inline constexpr bool type_not_scannable = false;

template <typename input, typename T> [[nodiscard]] inline constexpr bool scan_single_impl(input in, T arg)
{
    using char_type = typename input::input_char_type;
#if 0
