	...
	::std::size_t n,::fast_io::intfpos_t off)
{
	if constexpr(::fast_io::details::mutex_unlocked_buffer_input_stream_impl<instmtype>)
	{
		...
		return ::fast_io::details::scatter_pread_some_bytes_impl(::fast_io::details::input_stream_unlocked_ref_impl(insm),pscatters,n,off);
	}
	else
	{
	...
	::fast_io::intfpos_t off)
{
	...
	{
		::fast_io::operations::stream_ref_lock_guard lg{input_stream_mutex_ref_impl(insm)};
		return ::fast_io::details::scatter_pread_all_bytes_impl(::fast_io::details::input_stream_unlocked_ref_impl(insm),pscatters,n,off);
	}
	else
	{
