...
inline constexpr io_scatter_status_t scatter_read_some(instmtype&& instm,
	basic_io_scatter_t<typename decltype(::fast_io::manipulators::input_stream_ref(instm))::input_char_type> const *pscatter,::std::size_t len)
{
...
inline constexpr io_scatter_status_t scatter_pread_some(instmtype&& instm,
	basic_io_scatter_t<typename decltype(::fast_io::manipulators::input_stream_ref(instm))::input_char_type> const *pscatter,::std::size_t len,::fast_io::intfpos_t off)
{
