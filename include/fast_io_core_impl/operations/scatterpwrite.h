	...
	::std::size_t n,::fast_io::intfpos_t off)
{
	if constexpr(::fast_io::details::mutex_unlocked_buffer_output_stream_impl<outstmtype>)
	{
		...
		return ::fast_io::details::scatter_pwrite_some_impl(::fast_io::details::output_stream_unlocked_ref_impl(outsm),pscatters,n);
	}
	else
	{
	...
	::std::size_t n,::fast_io::intfpos_t off)
{
	...
	{
		::fast_io::operations::stream_ref_lock_guard lg{output_stream_mutex_ref_impl(outsm)};
		return ::fast_io::details::scatter_pwrite_all_impl(::fast_io::details::output_stream_unlocked_ref_impl(outsm),pscatters,n);
	}
	else
	{
