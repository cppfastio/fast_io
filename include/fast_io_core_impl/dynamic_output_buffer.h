...
template <typename T> class basic_dynamic_output_buffer_ref
{
  public:
...
obuffer_begin(basic_dynamic_output_buffer_ref<basic_generic_dynamic_output_buffer<char_type, buffersize, allocatortype>>
                  bdobr) noexcept
{
...
template <::std::integral char_type, ::std::size_t buffersize, typename allocatortype>
inline constexpr char_type *
obuffer_curr(basic_dynamic_output_buffer_ref<basic_generic_dynamic_output_buffer<char_type, buffersize, allocatortype>>
                 bdobr) noexcept
{
...
template <::std::integral char_type, ::std::size_t buffersize, typename allocatortype>
inline constexpr char_type *
obuffer_end(basic_dynamic_output_buffer_ref<basic_generic_dynamic_output_buffer<char_type, buffersize, allocatortype>>
                bdobr) noexcept
{
