...
template <::std::integral char_type> inline constexpr bool is_c_alnum(char_type ch) noexcept
{
...
template <::std::integral char_type> inline constexpr bool is_c_alpha(char_type ch) noexcept
{
    if constexpr (::std::same_as<char, char_type>)
        switch (ch)
        {
...
template <::std::integral char_type> inline constexpr bool is_c_lower(char_type ch) noexcept
{
    if constexpr (::std::same_as<char, char_type>)
        switch (ch)
        {
...
template <::std::integral char_type> inline constexpr bool is_c_upper(char_type ch) noexcept
{
    if constexpr (::std::same_as<char, char_type>)
        switch (ch)
        {
...
template <::std::integral char_type> inline constexpr bool is_c_digit(char_type ch) noexcept
{
    if constexpr (::std::same_as<char, char_type>)
        switch (ch)
        {
...
template <::std::integral char_type> inline constexpr bool is_c_xdigit(char_type ch) noexcept
{
    if constexpr (::std::same_as<char, char_type>)
        switch (ch)
        {
...
template <::std::integral char_type> inline constexpr bool is_c_punct(char_type ch) noexcept
{
    if constexpr (::std::same_as<char, char_type>)
        switch (ch)
        {
...
template <::std::integral char_type> inline constexpr bool is_c_graph(char_type ch) noexcept
{
    if constexpr (::std::same_as<char, char_type>)
        switch (ch)
        {
...
template <::std::integral char_type> inline constexpr bool is_c_print(char_type ch) noexcept
{
    if constexpr (::std::same_as<char, char_type>)
        switch (ch)
        {
...
template <::std::integral char_type> inline constexpr char_type to_c_lower(char_type ch) noexcept
{
...
template <::std::integral char_type> inline constexpr char_type to_c_upper(char_type ch) noexcept
{
    using unsigned_char_type = ::std::make_unsigned_t<char_type>;
    if constexpr (!::fast_io::details::is_ebcdic<char_type>)
        return static_cast<char_type>(
...
template <bool use_ebcdic, ::std::integral char_type> inline constexpr bool is_c_space_impl(char_type ch) noexcept
{
...
template <bool ebcdic, ::std::integral char_type> inline constexpr auto is_c_space_tb_impl() noexcept
{
...
template <::std::integral char_type> inline constexpr bool is_c_space(char_type ch) noexcept
{
...
namespace details
{
template <::std::unsigned_integral char_type> inline constexpr bool is_html_whitespace_ascii_impl(char_type ch) noexcept
{
    switch (ch)
    {
        case 0x0009:
...
template <::std::integral char_type> inline constexpr bool is_html_whitespace(char_type ch) noexcept
{
    using unsigned_char_type = ::std::make_unsigned_t<char_type>;
    if constexpr (::fast_io::details::is_ebcdic<char_type>)
    {
...
template <::std::integral char_type> inline constexpr bool is_c_halfwidth(char_type ch) noexcept
{
    using unsigned_char_type = ::std::make_unsigned_t<char_type>;
    if constexpr (sizeof(char_type) < sizeof(char32_t))
    {
...
template <::std::integral char_type> inline constexpr bool is_c_fullwidth(char_type ch) noexcept
{
    using unsigned_char_type = ::std::make_unsigned_t<char_type>;
    if constexpr (sizeof(char_type) < sizeof(char32_t))
    {
...
template <::std::integral char_type> inline constexpr char_type to_c_halfwidth(char_type ch) noexcept
{
    using unsigned_char_type = ::std::make_unsigned_t<char_type>;
    if constexpr (sizeof(char_type) < sizeof(char32_t))
    {
