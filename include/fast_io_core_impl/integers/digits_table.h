...
template <::std::integral char_type, bool upper> inline constexpr auto charliteralofnumber(char8_t v) noexcept
{
    if (v < 10u)
    {
...
template <::std::integral char_type, ::std::size_t base, bool upper> inline constexpr auto &get_digits_table() noexcept
{
