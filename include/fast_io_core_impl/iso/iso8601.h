...
template <::std::int_least64_t off_to_epoch> struct basic_timestamp
{
    ...
    template <::std::floating_point flt_type> explicit constexpr operator flt_type() noexcept
    {
...
template <::std::signed_integral T> inline constexpr T sub_overflow(T a, T b) noexcept
{
...
template <::std::integral char_type> struct timestamp_scan_state_t : private timestamp_scan_context_buffer_max_size_t
{
