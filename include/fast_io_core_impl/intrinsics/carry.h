...
template <typename T> inline constexpr T addc(T a, T b, bool carryin, bool &carryout) noexcept
{
...
template <typename T> inline constexpr T subc(T a, T b, bool carryin, bool &carryout) noexcept
{
#if __has_cpp_attribute(assume)
    [[assume(carryin == 0 || carryin == 1)]];
#endif
