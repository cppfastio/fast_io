...
namespace fast_io
{
template <::std::integral ch_type, ::std::input_iterator It> struct sized_range_view_t
{
...
template <::std::integral ch_type, ::std::input_iterator It> struct range_view_t
{
    using char_type = ch_type;
    using iterator = It;
    basic_io_scatter_t<char_type> sep;
...
template <::std::ranges::range rg, ::fast_io::constructible_to_os_c_str T> inline constexpr auto rgvw(rg &&r, T &&sep)
{
    using ::fast_io::range_view_t;
    using ::fast_io::sized_range_view_t;
    using ::std::to_address;
