...
inline constexpr mmap_prot& operator&=(mmap_prot& x, mmap_prot y) noexcept{return x=x&y;}
...
inline constexpr mmap_flags& operator&=(mmap_flags& x, mmap_flags y) noexcept{return x=x&y;}
