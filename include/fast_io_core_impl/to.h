                          ...
                          (!(contiguous_scannable<char_type, T> && sizeof...(args) == 1)))
            {
                ...
                else
                {
                    ::std::size_t const maximum_reserve_size{
                        ::fast_io::details::calculate_print_normal_dynamic_maxium_main<char_type, false>(0, args...)};
                    ::fast_io::details::local_operator_new_array_ptr<char_type> heap_buffer(maximum_reserve_size);
                    ::fast_io::details::inplace_to_decay_buffer_context_impl<char_type>(heap_buffer.ptr, state, t,
                                                                                        args...);
                }
            }
...
template <typename T, typename... Args> inline constexpr void inplace_to(T &&t, Args &&...args)
{
...
template <typename T, typename... Args> inline constexpr void winplace_to(T &&t, Args &&...args)
{
...
template <typename T, typename... Args> inline constexpr void u8inplace_to(T &&t, Args &&...args)
{
...
template <typename T, typename... Args> inline constexpr T u16inplace_to(T &&t, Args &&...args)
{
...
template <typename T, typename... Args> inline constexpr T u32inplace_to(T &&t, Args &&...args)
{
...
template <::std::integral char_type, typename T, typename... Args> inline constexpr T basic_to_decay(Args... args)
{
    constexpr bool failed{::fast_io::details::can_do_inplace_to<char_type, T, Args...>};
    if constexpr (sizeof...(Args) == 0)
    {
...
template <::std::integral char_type, typename T, typename... Args> inline constexpr T basic_to(Args &&...args)
{
    constexpr bool failed{::fast_io::details::can_do_inplace_to<char_type, T, Args...>};
    if constexpr (failed)
    {
...
template <typename T, typename... Args> [[nodiscard]] inline constexpr T to(Args &&...args)
{
    constexpr bool failed{::fast_io::details::can_do_inplace_to<char, T, Args...>};
    if constexpr (failed)
    {
...
template <typename T, typename... Args> [[nodiscard]] inline constexpr T wto(Args &&...args)
{
    constexpr bool failed{::fast_io::details::can_do_inplace_to<wchar_t, T, Args...>};
    if constexpr (failed)
    {
...
template <typename T, typename... Args> [[nodiscard]] inline constexpr T u8to(Args &&...args)
{
    constexpr bool failed{::fast_io::details::can_do_inplace_to<char8_t, T, Args...>};
    if constexpr (failed)
    {
...
template <typename T, typename... Args> [[nodiscard]] inline constexpr T u16to(Args &&...args)
{
    constexpr bool failed{::fast_io::details::can_do_inplace_to<char16_t, T, Args...>};
    if constexpr (failed)
    {
...
template <typename T, typename... Args> [[nodiscard]] inline constexpr T u32to(Args &&...args)
{
    constexpr bool failed{::fast_io::details::can_do_inplace_to<char32_t, T, Args...>};
    if constexpr (failed)
    {
