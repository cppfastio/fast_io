...
template <input_stream input> constexpr auto ibuffer_begin(single_character_input_buffer<input> &in)
{
    return __builtin_addressof(in.single_character);
}
template <input_stream input> constexpr auto ibuffer_curr(single_character_input_buffer<input> &in)
{
    return __builtin_addressof(in.single_character) + static_cast<::std::size_t>(in.pos);
}
template <input_stream input> constexpr auto ibuffer_end(single_character_input_buffer<input> &in)
{
...
template <input_stream input> constexpr bool ibuffer_underflow(single_character_input_buffer<input> &in)
{
...
template <input_stream input> constexpr void avoid_scan_reserve(single_character_input_buffer<input> &) {}
