...
template <::std::integral char_type> inline constexpr ::std::size_t dummy_cstr_len(char_type const *cstr) noexcept
{
    ::std::size_t n{};
    for (; *cstr; ++cstr)
        ++n;
...
template <::std::integral char_type> inline constexpr ::std::size_t cstr_len(char_type const *cstr) noexcept
{
