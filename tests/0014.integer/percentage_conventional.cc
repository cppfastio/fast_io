...
int main()
{
	...
	::fast_io::io::println(
		...
		"-99985000/-100000000=",percentage_conventional(99985000,-100000000),"\n"
		"-99985000/100000000=",percentage_conventional(99985000,-100000000),"\n"
		"850308345/971424125=",percentage_conventional(850308345,971424125),"\n"
		...
		"INT64_MIN/INT64_MAX=",percentage_conventional(INT64_MIN,INT64_MAX),"\n"
		"INT64_MIN/UINT64_MAX=",percentage_conventional(INT64_MIN,UINT64_MAX)
		);
}
