...
int main()
{
	...
	x86_64_mangling.append(gen_pragmas(u8"arm-windows-msvc.s", win32_symbols, nt_symbols));
...
// clang-format on
	...
	::fast_io::native_file output{"../../../include/fast_io_hosted/platforms/win32/msvc_linker_32.h", ::fast_io::open_mode::out};
