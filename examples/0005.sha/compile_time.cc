...
int main()
{
	...
	static_assert(
		std::u8string_view(sha512.data(), sha512.size()) ==
		u8"bdb8ef7e35e183cf07806dd6502854f1dc15570b05e420d6cee96cd321a9f483b0f2855d3cd1d0472fec7e87d21883ff817a4147bd31b9633eda27f97a3238a5"sv);
